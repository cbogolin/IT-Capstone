...
function displayCountryInfo(clickedCountry) {
    ...
    let region = countryObject.Region;
    let regionObject = regions.find(x => x["Region"] === region);
    ...
    $('#iFinInc').html(countryObject["FinIncresid"]);
    $('#iGPI').html(countryObject["GPIresid"]);
    $('#iFemLit').html(countryObject["FemLitresid"]);
    $('#ilnChldMort').html(countryObject["lnChldMortresid"]);
    $('#iWaste').html(countryObject["Wasteresid"]);
    $('#iMSExpShr').html(countryObject["MSExpShrresid"]);
    $('#ilninflation').html(countryObject["lninflationresid"]);
    $('#iPolity2').html(countryObject["Polity2resid"]);
    $('#iGINI').html(countryObject["GINIresid"]);
    $('#iMedPov').html(countryObject["MedPovresid"]);
    $('#ilnNRR').html(countryObject["lnNRRresid"]);
    $('#iImpWat').html(countryObject["ImpWatresid"]);
    $('#FinInc2').html(regionObject["FinInc"]);
    $('#GPI2').html(regionObject["GPI"]);
    $('#FemLit2').html(regionObject["FemLit"]);
    $('#lnChldMort2').html(regionObject["lnCholdMort"]);
    $('#Waste2').html(regionObject["Waste"]);
    $('#MSExpShr2').html(regionObject["MSExpShr"]);
    $('#lninflation2').html(regionObject["lninflation"]);
    $('#Polity2_2').html(regionObject["Polity2"]);
    $('#GINI2').html(regionObject["GINI"]);
    $('#MedPov2').html(regionObject["MedPov"]);
    $('#lnNRR2').html(regionObject["lnNRR"]);
    $('#ImpWat2').html(regionObject["ImpWat"]);
