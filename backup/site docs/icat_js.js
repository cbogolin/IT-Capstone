  ...
  console.log(firstCountry['Country Name']);
...
//Once a country is selected (currently, only from the dropdown since there is no heatmap), this triggers
//a modal to pop up and display the country information

$('.selectCountryDropdown').change(function() { //grabs value from the dropdown only
  var opval = $(this).val(); //Get value from selected country in the dropdown
